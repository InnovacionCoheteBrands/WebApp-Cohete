  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {/* Proyectos activos */}
        <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg border dark:border-[#2a3349] dark:shadow-none hover:-translate-y-1 dark:hover:shadow-[0_5px_20px_rgba(0,0,0,0.3)] dark:bg-[#1a1d2d] relative before:absolute before:top-0 before:left-0 before:h-1 before:w-full before:bg-primary dark:before:bg-[#65cef5]">
          <CardContent className="p-0">
            <div className="p-5 relative z-10">
              <div className="flex items-start justify-between">
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary dark:bg-[#1e293b] dark:text-[#65cef5] dark:shadow-[0_0_10px_rgba(101,206,245,0.15)] dark:border dark:border-[#3e4a6d] group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
              ...
              <div className="mt-4 space-y-2.5">
                <div className="h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div className="h-full bg-primary dark:bg-[#65cef5]" style={{ width: `${activeProjectsCount > 0 ? (activeProjectsCount / 10) * 100 : 10}%` }}></div>
                </div>
                <div className="text-xs text-muted-foreground dark:text-slate-400 flex justify-between">
                  <span>Total: {activeProjectsCount}</span>
                  <span className="font-medium text-primary dark:text-[#65cef5]">{activeProjectsCount > 0 ? Math.min(Math.round((activeProjectsCount / 10) * 100), 100) : 10}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-2 px-5 pb-5">
              <Link href="/projects" className="block w-full">
                <Button className="w-full relative overflow-hidden group dark:bg-[#2a3349] dark:text-white dark:hover:bg-[#374151] h-11 font-medium shadow-sm dark:shadow-[0_2px_10px_rgba(0,0,0,0.2)]">
        ...
        <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg border dark:border-[#2a3349] dark:shadow-none hover:-translate-y-1 dark:hover:shadow-[0_5px_20px_rgba(0,0,0,0.3)] dark:bg-[#1a1d2d] relative before:absolute before:top-0 before:left-0 before:h-1 before:w-full before:bg-amber-500">
          <CardContent className="p-0">
            <div className="p-5 relative z-10">
              <div className="flex items-start justify-between">
                <div className="space-y-1.5">
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-amber-500/10 text-amber-600 dark:bg-amber-600/20 dark:text-amber-300 dark:shadow-[0_0_10px_rgba(245,158,11,0.15)] dark:border dark:border-amber-600/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
              ...
              <div className="mt-4 space-y-2.5">
                <div className="h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div className="h-full bg-amber-500 dark:bg-amber-500/80" style={{ width: `${recentSchedulesCount > 0 ? (recentSchedulesCount / 5) * 100 : 20}%` }}></div>
                </div>
                <div className="text-xs text-muted-foreground dark:text-slate-400 flex justify-between">
                  <span>Total: {recentSchedulesCount}</span>
                  <span className="font-medium text-amber-600 dark:text-amber-400">{recentSchedulesCount > 0 ? Math.min(Math.round((recentSchedulesCount / 5) * 100), 100) : 20}%</span>
                </div>
              </div>
            </div>
        ...
        {/* Tareas pendientes */}
        <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg border dark:border-[#2a3349] dark:shadow-none hover:-translate-y-1 dark:hover:shadow-[0_5px_20px_rgba(0,0,0,0.3)] dark:bg-[#1a1d2d] relative before:absolute before:top-0 before:left-0 before:h-1 before:w-full before:bg-destructive dark:before:bg-red-500">
          <CardContent className="p-0">
            <div className="p-5 relative z-10">
              <div className="flex items-start justify-between">
                <div className="space-y-1.5">
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-destructive/10 text-destructive dark:bg-red-500/20 dark:text-red-300 dark:shadow-[0_0_10px_rgba(239,68,68,0.15)] dark:border dark:border-red-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
              ...
              <div className="mt-4 space-y-2.5">
                <div className="h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div className="h-full bg-destructive dark:bg-red-500/80" style={{ width: `${pendingTasksCount > 0 ? (pendingTasksCount / 10) * 100 : 30}%` }}></div>
                </div>
                <div className="text-xs text-muted-foreground dark:text-slate-400 flex justify-between">
                  <span>Total: {pendingTasksCount}</span>
                  <span className="font-medium text-destructive dark:text-red-400">{pendingTasksCount > 0 ? Math.min(Math.round((pendingTasksCount / 10) * 100), 100) : 30}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-2 px-5 pb-5">
              <Link href="/tasks" className="block w-full">
                <Button 
                  variant="outline" 
                  className="w-full border-destructive bg-destructive/10 text-destructive hover:bg-destructive/20 relative overflow-hidden group dark:bg-red-950/30 dark:hover:bg-red-900/40 dark:border-red-800/50 dark:text-red-300 h-11 font-medium shadow-sm dark:shadow-[0_2px_10px_rgba(0,0,0,0.2)]"
                >
                  <span className="relative z-10 flex items-center">
                    Ver Tareas
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Calendario Rápido */}
        <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg border dark:border-[#2a3349] dark:shadow-none hover:-translate-y-1 dark:hover:shadow-[0_5px_20px_rgba(0,0,0,0.3)] dark:bg-[#1a1d2d] relative before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-blue-500">
          <CardContent className="p-0">
            <div className="p-5 relative z-10">
              ...
              <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="space-y-1 text-sm p-3 rounded-lg bg-white/80 border border-gray-100 shadow-sm dark:bg-[#1e293b]/50 dark:border-[#3e4a6d] group-hover:border-blue-200 dark:group-hover:border-blue-800/30 transition-colors duration-300">
        ...
        {/* Calendario Avanzado */}
        <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg border dark:border-[#2a3349] dark:shadow-none hover:-translate-y-1 dark:hover:shadow-[0_5px_20px_rgba(0,0,0,0.3)] dark:bg-[#1a1d2d] relative before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-amber-500">
          <CardContent className="p-0">
            <div className="p-5 relative z-10">
              <div className="flex items-start">
              ...
              <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="space-y-1 text-sm p-3 rounded-lg bg-white/80 border border-gray-100 shadow-sm dark:bg-[#1e293b]/50 dark:border-[#3e4a6d] group-hover:border-amber-200 dark:group-hover:border-amber-800/30 transition-colors duration-300">
                  <div className="font-medium dark:text-white flex items-center gap-1.5">
