...
export default function WelcomeSection({ user }: WelcomeSectionProps) {
  ...
  return (
    <div 
      className="rounded-xl bg-gradient-to-r from-gray-800 to-gray-900 p-6 text-white shadow-lg relative overflow-hidden dark:from-[#1e293b] dark:to-[#0f172a] dark:border dark:border-[#3e4a6d] dark:shadow-[0_0_25px_rgba(0,0,0,0.3)]"
    ...
    >
      ...
      <div className="flex flex-col space-y-3 relative z-10">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <button 
            className="rounded-md bg-white px-5 py-2.5 text-sm font-medium text-primary shadow-sm hover:bg-white/90 transition-all duration-200 active:scale-95 dark:bg-[#65cef5] dark:text-[#1a1d2d] dark:hover:bg-[#5bb7dd] dark:shadow-[0_0_10px_rgba(101,206,245,0.3)] flex items-center gap-1.5"
