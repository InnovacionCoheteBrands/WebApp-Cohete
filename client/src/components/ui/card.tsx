...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("relative z-20 flex flex-col space-y-1.5 p-6", className)}
    {...props}
  />
))
...
const CardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("relative z-20 p-6 pt-0 text-slate-300", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("relative z-20 flex items-center p-6 pt-0", className)}
    {...props}
  />
))
